...
def run_buy_isolation(candles):

    print()
    print("=" * 125)
    print("BUY ISOLATION | SELL FIXED AT 70")
    print("=" * 125)
...
def run_sell_isolation(candles):

    print()
    print("=" * 125)
    print("SELL ISOLATION | BUY FIXED AT 30")
    print("=" * 125)
...
def main():
    ...
    for dataset_name, path in DATASETS:
        ...
        run_buy_isolation(candles)
        run_sell_isolation(candles)
