...
def calculate_metrics(profits, initial_balance=1000.0):
    ...
    return balance, balance - initial_balance, max_drawdown


def monte_carlo(profits, simulations=10000, seed=42):
    ...
    for _ in range(simulations):
        ...
        final_balance, profit, max_drawdown = calculate_metrics(shuffled)
...
print()
print("=" * 120)
print("=== MONTE CARLO | FROZEN STRATEGY | 10,000 RANDOM TRADE ORDERS ===")
print("=" * 120)
print("BUY=33.8 | SELL=68.5 | TIME=241 | RSI=classic | MIN_DIFF=1.0 | FEE=0.0004")
print("Randomizacja dotyczy WYŁĄCZNIE kolejności już wykonanych transakcji.")
print()
...
for name, profits in [
    ...
    print()
    print(f"Średni profit MC        : {metrics['mean_profit']:.4f}")
    print(f"Mediana profit MC       : {metrics['median_profit']:.4f}")
